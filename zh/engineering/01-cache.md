...
写在前面：这两周陪家人出门旅行，写文章的时间变少，所以今天先更新一篇《推荐工程实践》系列文章。原先的《推荐系统架构》系列下周再恢复更新。
...
整个流程参考下图，该图首次出现在《推荐系统架构》的第10篇《在线系统总览》中，大家如果没看过可以 [点击这里](https://mp.weixin.qq.com/s/p8oAzAxys9MvKxARuQdUvw) 查看。下面流程描述有一些概念（例如 Recall Manager）也在这篇文章有介绍，如果之前没见过可以查阅。
